...
<section id="home" class="hero">
    <div class="container">
      <div class="row align-items-center gy-4 justify-content-center text-center">
        <div class="col-lg-8">
          <div class="badge-pill mb-3 text-center">About Us</div>
          <h1 class="hero-title">
            Custom Logo Design, <span>Branding & Website</span> Solutions.
          </h1>
          <p class="hero-text mb-4">
            Design Centura is essentially an institution where simple ideas are converted into brilliant and passionate products.
          </p>
        </div>
      </div>
    </div>
...
<section id="about">
    <div class="container">
      <div class="row align-items-center gy-4">
        <div class="col-lg-6">
          <p class="section-eyebrow left">About the studio</p>
          <h2 class="section-title">We Bring <span class="blue">Brands</span> into the <span class="blue">Digital World</span>.</h2>
          <p class="mb-3">
            We help startups and established businesses build strong visual identities –
            from logo and stationery to websites and digital campaigns – so they can show
            up consistently across every channel.
          </p>
          <p class="mb-3">
            Strategy, design, and development work together here. Every logo, landing page,
            and banner is crafted with your audience and market in mind.
          </p>
